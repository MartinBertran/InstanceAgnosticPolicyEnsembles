...
void Game::parse_options(std::string name, VecOptions opts) {
    ...
    opts.consume_bool("use_data_augmentation", &options.use_data_augmentation); //TODO MB
...
void Game::serialize(WriteBuffer *b) {
    ...
    b->write_int(options.use_data_augmentation); //TODO MB
...
void Game::deserialize(ReadBuffer *b) {
    ...
    options.use_data_augmentation = b->read_int(); //TODO MB
